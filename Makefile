...
uptest: $(UPTEST) $(KUBECTL) $(KUTTL)
	...
	@KUBECTL=$(KUBECTL) CROSSPLANE_NAMESPACE=$(CROSSPLANE_NAMESPACE) KUTTL=$(KUTTL) $(UPTEST) e2e examples/cache.yaml --setup-script=test/setup.sh --default-timeout=3600 || $(FAIL)
...
render:
	crossplane beta render examples/cache.yaml apis/composition.yaml examples/function/function.yaml -r
