...
"${KUBECTL}" wait configuration.pkg configuration-aws-elasticache --for=condition=Healthy --timeout 5m
"${KUBECTL}" wait configuration.pkg configuration-aws-elasticache --for=condition=Installed --timeout 5m
